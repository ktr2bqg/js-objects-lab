...
//Exercise 5
game.party.push(pokemon[3], pokemon[6], pokemon[62])
...
Set the completed property to  true for gyms/Difficulty below 3
Loop
*/
for (let index = 0; index < game.gyms.length; index++) {
  if (game.gyms[index].difficulty < 3) {
...
*/
for (let index = 0; index < game.gyms.length; index++) {
  if (game.gyms[index].difficulty < 6) {
    game.gyms[index].completed = true;
  }
}
console.log(game.gyms);
...
*/
for (let index = 0; index < game.gyms.length; index++) {
  if (game.gyms[index].difficulty < 8) {
    game.gyms[index].completed = true;
  }
}
console.log(game.gyms);
